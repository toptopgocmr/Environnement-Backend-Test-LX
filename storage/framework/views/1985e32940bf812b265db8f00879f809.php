...
<body class="flex items-center justify-center min-h-screen px-4 py-10">
    ...
    <div class="card">
        ...
        <?php endif; ?>
        <?php if($errors->any()): ?>
            <div class="bg-red-50 border border-red-200 text-red-700 rounded-xl p-3 mb-4 text-sm"><?php echo e($errors->first()); ?></div>
        <?php endif; ?>
        ...
        <form action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-4">
            ...
            <div class="flex items-center justify-between text-sm">
                ...
                <a href="<?php echo e(route('password.request')); ?>" class="text-amber-600 hover:text-amber-700 font-medium">Mot de passe oublié ?</a>
            </div>
...
<?php /**PATH C:\Users\Lenovo Yoga\Downloads\LireX-APP\backend\resources\views/auth/login.blade.php ENDPATH**/ ?>