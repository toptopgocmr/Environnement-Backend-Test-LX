...
.chat-input { border:1.5px solid #d5d9d9; border-radius:6px; padding:10px 14px; font-size:.85rem; color:#16191f; outline:none; resize:none; transition:border-color .15s; line-height:1.5; font-family:inherit; }
...
<div style="max-width:760px; margin:0 auto;">
  ...
  <div style="background:#fff; border:1px solid #d5d9d9; border-radius:6px; padding:14px 18px; margin-bottom:16px; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px;">
    ...
    <div style="display:flex; align-items:center; gap:10px;">
      ...
      @endif
      <a href="{{ route('author.chat.index') }}" style="font-size:.8rem; color:#0073bb; text-decoration:none;">← Retour</a>
    </div>
  </div>
  ...
  <form id="chat-form">
    <div style="display:flex; gap:10px; align-items:flex-end;">
      <textarea id="chat-input" rows="2" required placeholder="Votre message… (Ctrl+Entrée pour envoyer)" class="chat-input" style="flex:1;"></textarea>
      <button type="submit" class="btn-primary" style="height:46px; flex-shrink:0; display:flex; align-items:center; gap:6px;">
