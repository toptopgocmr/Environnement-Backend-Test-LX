...
<head>
    ...
    <title>LireX – Réinitialiser le mot de passe</title>
...
<body class="min-h-screen flex items-center justify-center" style="background:#0A1628">
    <div class="w-full max-w-md p-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <h1 class="text-xl font-bold text-gray-900 mb-2">Réinitialiser le mot de passe</h1>
            <p class="text-sm text-gray-500 mb-6">Choisissez un nouveau mot de passe.</p>
